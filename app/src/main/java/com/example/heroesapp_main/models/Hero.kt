...
data class Hero(
    ...
    companion object {
        val heroes = listOf(
            ...
            Hero(5, "Spider-Man", "Friendly neighborhood superhero", "https://preview.redd.it/2f97an638ty71.png?auto=webp&s=86daa412084340c70f70ef49a0ad06487a7fc49a", 1),
            ...
            Hero(7, "Mujer Maravilla", "Amazonian warrior", "https://static.wikia.nocookie.net/death-battle-fanon-wiki-en-espanol/images/9/96/Mujer_Maravilla.png/revision/latest/thumbnail/width/360/height/360?cb=20190323022056&path-prefix=es", 2),
            Hero(8, "Flash", "Fastest man alive", "https://pngfre.com/wp-content/uploads/the-flash-42-240x300.png", 2),
            Hero(9, "Victor Stone", "Cyborg", "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/f551ed82-19db-4ec0-a41f-8134ef2bebd2/dfypg8f-46a1c86d-d590-48f8-8ef9-7e7994220148.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..4BeO0GBj2mFj5DKxJ4KGYJnRQr-oCbUPO6JZDd6UwlE", 2),
            Hero(10, "Detective Marciano", "Martian warrior", "https://static.wikia.nocookie.net/vsbattles/images/5/5b/Martian_Manhunter_%28New_52%29_1.png/revision/latest?cb=20210902183734", 2)
        )
    }
}